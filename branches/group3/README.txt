Za naš svc_delay potrebujemo v trunk-u še:
...
- dodati strukturo enega DELAY block-a v DELAY LIST-i
	...
	.equ  D_TCB,    0                               /* kazalec na pripadajoè TCB procesa */
	.equ  D_TOUT,   D_TCB+4                         /* vrednost urinih period izkljuèitve procesa */
	
======================================================================================================

kodo SVC_DELAY dodamo danes èez dan